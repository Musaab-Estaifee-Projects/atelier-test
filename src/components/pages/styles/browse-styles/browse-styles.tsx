...
import DiamondRuleFull from "@/components/icons/configurator/diamond-rule-full";
import Bg from "@/components/shared/bg";
import StyleCard from "@/components/pages/styles/browse-styles/style-card";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
const BrowseStyles = ({
  ...
  const slides = [...CATALOG_STYLES, ...CATALOG_STYLES];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full w-full flex-col px-4 pt-6 pb-6 sm:px-6 sm:pt-8 lg:px-8">
        {/* Header */}
        <div className="flex shrink-0 flex-col items-center">
          ...
          <DiamondRuleFull className="mt-3 h-4 w-40 sm:mt-4 sm:w-44" />

          <p className="mt-2.5 max-w-[320px] text-center text-[12px] leading-[1.2] text-white/70 sm:mt-3 sm:text-[14px]">
            Choose a style that reflect you vision and lifestyle
          </p>
        </div>

        {/* Measured container */}
        <div ref={containerRef} className="mt-6 min-h-0 flex-1 sm:mt-8">
          <Carousel
            opts={{
              loop: true,
              align: "start",
            ...
            <CarouselContent className="-ml-3 sm:-ml-4">
              {slides.map((style, index) => (
                <CarouselItem
                  ...
                  className="basis-2/3 pl-3 sm:basis-2/5 sm:pl-4 lg:basis-2/7 2xl:basis-2/9"
                >
