...
export default function ReturnConfiguration({ open, onClose }: Props) {
  ...
  return (
    ...
    >
      <div className="relative w-full overflow-hidden">
        ...
        <img
          src="/images/quotation/return-dialog-frame.svg"
          alt=""
        ...
        >
          <h2 className="w-full text-center font-libre-baskerville text-[clamp(22px,4vw,27.4px)] leading-[1.16] font-normal tracking-[1.37px] text-white">
