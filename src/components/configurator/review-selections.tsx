...
export default function ReviewSelections({
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-x-0 top-0 h-[min(282px,42vw)] overflow-hidden opacity-50">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[749px] flex-1 flex-col hidden-scrollbar overflow-y-auto px-4 pt-6 pb-[140px] sm:px-0 sm:pt-6">
      ...
      <footer className="absolute inset-x-0 bottom-0 z-20 border-t border-white/10 bg-[#00272d]/95 backdrop-blur-md">
        <div className="mx-auto flex w-full max-w-[749px] flex-col gap-4 px-4 py-4 sm:h-[96px] sm:flex-row sm:items-center sm:justify-between sm:px-0 sm:py-0">
          <div>
