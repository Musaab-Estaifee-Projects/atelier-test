// src/mocks/configurator/session.ts
...
export function slotFromCamera(name: string, mode?: string): string | undefined {
  const key = `${name} ${mode ?? ""}`.toLowerCase();
  if (name.startsWith("CAM-LV-SW") || key.includes("sofa") || mode?.includes("Sofa"))
  ...
  if (key.includes("br-01") || key.includes("bedroom 01")) {
    ...
    if (key.includes("hb") || key.includes("head")) return "bedroom-01-headboard";
    if (key.includes("wd") || key.includes("ward")) return "bedroom-01-wardrobe";
  ...
  if (key.includes("br-02") || key.includes("bedroom 02")) {
    ...
    if (key.includes("hb") || key.includes("head")) return "bedroom-02-headboard";
    if (key.includes("wd") || key.includes("ward")) return "bedroom-02-wardrobe";
  ...
  if (name.startsWith("CAM-LV-SW") || name.includes("sofa") || mode?.includes("Sofa"))
    return "living-sofa-wall";
  return undefined;
}
...
> = {
  "MT-TW0001": { displayName: "Oak Cladding", category: "wood", pricePerSqm: 85 },
  "MT-TW0002": { displayName: "Walnut Cladding", category: "wood", pricePerSqm: 95 },
  "MT-WP0001": { displayName: "Linen Wallpaper", category: "wallpaper", pricePerSqm: 45 },
  "MT-WP0002": { displayName: "Geo Wallpaper", category: "wallpaper", pricePerSqm: 52 },
  "MT-WP0003": { displayName: "Botanical Wallpaper", category: "wallpaper", pricePerSqm: 58 },
  "MT-WP0004": { displayName: "Stripe Wallpaper", category: "wallpaper", pricePerSqm: 48 },
  "MT-WP0005": { displayName: "Texture Wallpaper", category: "wallpaper", pricePerSqm: 55 },
  "MT-PC0001": { displayName: "Matte White", category: "paint", pricePerSqm: 35 },
  "MT-PC0002": { displayName: "Soft Grey", category: "paint", pricePerSqm: 38 },
  "MT-PC0003": { displayName: "Sage Green", category: "paint", pricePerSqm: 42 },
  "MT-PC0004": { displayName: "Navy", category: "paint", pricePerSqm: 44 },
  "MT-PC0005": { displayName: "Warm Sand", category: "paint", pricePerSqm: 40 },
  "MT-FL0001": { displayName: "Oak Parquet", category: "floor", pricePerSqm: 120 },
  "MT-FL0002": { displayName: "Ash Parquet", category: "floor", pricePerSqm: 115 },
  "MT-FL0003": { displayName: "Carrara Marble", category: "floor", pricePerSqm: 180 },
  "MT-FL0004": { displayName: "Grey Marble", category: "floor", pricePerSqm: 165 },
  "MT-FL0005": { displayName: "Cream Marble", category: "floor", pricePerSqm: 170 },
  "MT-FL0006": { displayName: "White Porcelain", category: "floor", pricePerSqm: 90 },
  "MT-FL0007": { displayName: "Graphite Porcelain", category: "floor", pricePerSqm: 95 },
  "MT-FL0008": { displayName: "Beige Porcelain", category: "floor", pricePerSqm: 92 },
  "MT-CL0001": { displayName: "Ceiling White", category: "ceiling", pricePerSqm: 25 },
  "MT-CL0002": { displayName: "Ceiling Soft", category: "ceiling", pricePerSqm: 28 },
  "MT-CL0003": { displayName: "Ceiling Warm", category: "ceiling", pricePerSqm: 30 },
  "MT-GWD001": { displayName: "Glass Wardrobe", category: "wardrobe", pricePerSqm: 140 },
};
...
export function defaultEntryForSlot(
  session: { meshes: MeshOption[]; materialsByMesh: Record<string, string[]>; defaults?: SelectionEntry[] },
  slot: string,
): SelectionEntry | null {
...
export function buildMockSession(args: {
  ...
  const levelName =
    args.levelName?.trim() || "2BHK_Type_2_Updated";
