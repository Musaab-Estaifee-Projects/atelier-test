// // src/lib/configurator/materials.ts
...
//  *
//  * Pricing (RATE / PRICE PER SQM) lives on the backend; UI only needs ids + display names
//  * until the design system is ready for thumbnails/prices.
//  */
